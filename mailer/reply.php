<?php
    ...
    // More headers
    $headers .= 'From: hmahajan38@gmail.com' . "\r\n";
    // $headers .= 'BCC: hmahajan38@gmail.com '. "\r\n";
   
    $body = "<html>
            <body>
            <div style='font-family:Helvetica,Arial,sans-serif;line-height:125%;color:#242424;font-size:14px'>
                                                                ...
                                                                <tbody>
                                                                    <tr bgcolor='#ffffff'>
                                                                        <td align='left'
                                                                            ...
                                                                            <br><br>
                                                                            I appreciate you for contacting me.
                                                                            <br>I have received your message and would like to
                                                                            thank you for writing to me.
                                                                            <br>I will reply you by email or call as soon as
                                                                            possible.<br>
                                                                            <br><br>
                                                                            Regards,
                                                                            <br>
