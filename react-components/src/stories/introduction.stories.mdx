...
import Code from '../assets/images/svg/code-brackets.svg';
import Colors from '../assets/images/svg/colors.svg';
import Comments from '../assets/images/svg/comments.svg';
import Direction from '../assets/images/svg/direction.svg';
import Flow from '../assets/images/svg/flow.svg';
import Plugin from '../assets/images/svg/plugin.svg';
import Repo from '../assets/images/svg/repo.svg';
import StackAlt from '../assets/images/svg/stackalt.svg';
